...
Snuggery usually reserves this for post-partum — ask specifically if it's available during labor.`,
    ...
    {
      id: 'be923c44-37c8-4072-8a04-0b78daf4eb75',
      type: 'action',
...
Snuggery doesn't commonly use this — confirm availability when requesting.`,
    ...
    {
      id: 'e67a9fb1-4b4f-4096-842d-0480ad300daa',
      type: 'action',
...
• Only before 7 cm dilation — given too late, sedation can affect the baby's breathing at birth`,
    ...
    {
      id: '77779b03-7fba-40fa-9934-1808deb789ef',
      type: 'action',
...
• Blood thinner (ONLY if C-section)`,
  ...
  edges: [
    ...
    {
      id: 'cbedfab2-f31e-436a-9113-50606acfb8a3',
      type: 'custom',
      source: 'pain-back',
    ...
    {
      id: 'f23f8a80-b960-4872-85d6-59f52d7f6cf9',
      type: 'custom',
    ...
    {
      id: '1f1412be-6223-4f71-bd86-269c3380a122',
      type: 'custom',
    ...
    {
      id: 'cac81940-f688-493e-a601-f1a9f5fb81b0',
      type: 'custom',
      source: 'f9298bd8-dcae-41c8-985f-ae2666813813',
    ...
    {
      id: 'd680a311-137d-4ddd-8c25-0ac6ab1bdf9c',
      type: 'custom',
      source: 'f9298bd8-dcae-41c8-985f-ae2666813813',
    ...
    {
      id: '39cd2032-cb13-4e0d-83ab-7fa018df6fd2',
      type: 'custom',
      source: 'be923c44-37c8-4072-8a04-0b78daf4eb75',
      target: 't3-n8',
      data: {},
    },
    {
      id: '9209b4ac-97a0-4110-af7b-4d0713f35902',
      type: 'custom',
      source: 'e67a9fb1-4b4f-4096-842d-0480ad300daa',
      target: 't3-n8',
      data: {},
    },
    {
      id: '5a289556-a968-4d07-a349-48e770408adb',
      type: 'custom',
      source: '77779b03-7fba-40fa-9934-1808deb789ef',
      target: 't3-n8',
      data: {},
    },
    {
